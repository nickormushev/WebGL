...
Cube = function(center,size)
{
	...
	this.texScale = 1; // мащаб на текстурата
	this.texCenter = [0,0]; // център на текстурата
...
Cube.prototype.draw = function()
{
	...
	useMatrix();
	gl.uniform1f(uTexScale,this.texScale); // мащаб на текстурата
	gl.uniform2fv(uTexCenter,this.texCenter); // център на текстурата
