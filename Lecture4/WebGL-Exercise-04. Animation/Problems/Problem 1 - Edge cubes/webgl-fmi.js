...
function lookAt(eye, look_direction, up) {
    view = viewMatrix(eye, look_direction, up);
    gl.uniformMatrix4fv(uViewMatrix,false,view);
}

function perspective(angle, aspectRatio, near, far) {
    let perspectiveMatrix = perspMatrix(angle, aspectRatio, near, far);
